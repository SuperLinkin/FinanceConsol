...
export default function CloseCalendar() {
  ...
  // Mock tasks auto-populated from task management (matching the structure from tasks page)
  const tasks = [
    {
      taskId: 'T001',
      ...
      endDate: '2025-01-02',
      status: 'completed', // completed, in_progress, pending, delayed
  ...
  const getTasksForDate = (dateStr) => {
    ...
    return tasks.filter(task => {
      ...
      // Check if date falls within task's date range
    ...
    <div className="flex h-screen bg-[#f7f5f2]">
      ...
      <div className="flex-1 overflow-auto">
        <ClosePageHeader
          ...
          subtitle="Manage tasks, events, and close timeline"
        />
